  ...
  function r(r) {
    ...
    function a() {
      ...
      if (
        (n < e
          ? 'hidden' === t.overflowY &&
            (s('scroll'), u(), (n = 'content-box' === t.boxSizing ? Math.round(parseFloat(window.getComputedStyle(r, null).height)) : r.offsetHeight))
          : 'hidden' !== t.overflowY &&
            (s('hidden'), u(), (n = 'content-box' === t.boxSizing ? Math.round(parseFloat(window.getComputedStyle(r, null).height)) : r.offsetHeight)),
        i !== n)
      ) {
        i = n;
