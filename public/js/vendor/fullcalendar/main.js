...
var FullCalendar = (function (exports) {
  ...
  function v(l, u, i, t, o) {
    var r = {type: l, props: u, key: i, ref: t, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: o};
  ...
  function T(n, l, u) {
    ...
    for (i = 0; i < n.__k.length; i++)
      (t = n.__k[i]) &&
        ((t.__ = n),
        t.__e &&
          ('function' == typeof t.type && t.__k.length > 1 && T(t, l, u), (l = x(u, t, t, n.__k, null, t.__e, l)), 'function' == typeof n.type && (n.__d = l)));
  }
        ...
        if (_this.isDragging) {
          ...
          if (validMutation) {
            ...
            if (receivingContext_1 === initialContext_1) {
              ...
              receivingContext_1.emitter.trigger(
                'eventReceive',
                __assign(__assign({}, eventAddArg), {draggedEl: ev.subjectEl, view: finalHit.component.context.viewApi}),
              );
            }
          } else {
                  ...
                  createElement(
                    ...
                    createElement(
                      ...
                      function (rootElRef, classNames, innerElRef, innerContent) {
                        return createElement(
                          'a',
                          {ref: rootElRef, className: ['fc-daygrid-more-link'].concat(classNames).join(' '), onClick: _this.handleMoreLinkClick},
                          innerContent,
                        );
                      },
                    ),
      ...
      return createElement(
        ...
        function (rootElRef, classNames, innerElRef, innerContent) {
          return (
            ...
            createElement(
              'a',
              __assign({className: ['fc-daygrid-event', 'fc-daygrid-dot-event'].concat(classNames).join(' '), ref: rootElRef}, getSegAnchorAttrs$1(props.seg)),
              innerContent,
            )
          );
        },
  ...
  function computeFgSegPlacement(cellModels, segs, dayMaxEvents, dayMaxEventRows, eventHeights, maxContentHeight, colCnt, eventOrderSpecs) { // for one row. TODO: print mode?
              ...
              return createElement(
                ...
                hasListItemDisplay(seg)
                  ? createElement(
                      TableListItemEvent,
                      __assign(
                        {seg: seg, isDragging: false, isSelected: instanceId === selectedInstanceId, defaultDisplayEventEnd: false},
                        getSegMeta(seg, todayRange),
                      ),
                    )
                  : createElement(
      ...
      return segs.map(function (seg) {
        return createElement(
          ...
          createElement(
            TimeColEvent,
            __assign(
              {seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: false, isCondensed: false},
