...
var FullCalendar = (function (e) {
  ...
  function m(e, t, n, r, o) {
    var a = {type: e, props: t, key: n, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: o};
    ...
    for (l == d && (l = null != a ? a[0] : w ? S(r, 0) : null), n.__k = [], c = 0; c < t.length; c++)
      if (
        ...
        (E = I(e, g, (h = h || d), o, i, a, s, l, u)),
          ...
          null != E
            ? (null == D && (D = E), (l = R(e, g, h, C, a, E, l)), u || 'option' != n.type ? 'function' == typeof n.type && (n.__d = l) : (e.value = ''))
  ...
  function _(e, t, n) {
    ...
    for (r = 0; r < e.__k.length; r++)
      (o = e.__k[r]) &&
        ((o.__ = e),
        o.__e &&
          ('function' == typeof o.type && o.__k.length > 1 && _(o, t, n), (t = R(n, o, o, e.__k, null, o.__e, t)), 'function' == typeof e.type && (e.__d = t)));
  }
  ...
  function Zt(e, t, n, r, o) {
    ...
    if (u)
      return (
        ((c = Jt(a, s, t ? t.sourceId : '', u.allDay, Boolean(u.duration), n)).recurringDef = {typeId: u.typeId, typeData: u.typeData, duration: u.duration}),
        {def: c, instance: null}
      );
    var c,
      d = (function (e, t, n, r) {
  ...
  function Dn(e, t, n, r, o, i, a) {
    ...
    if ((null == u && (u = !1 !== r), null == c && (c = !1 !== o), u && !d.allDay && (e.isStart || e.isEnd))) {
      ...
      return c && d.hasEnd
        ? s.formatRange(f, h, t, {forcedStartTzo: i ? null : p.forcedStartTzo, forcedEndTzo: a ? null : p.forcedEndTzo})
          ...
          if (e instanceof Bn) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({type: 'ADD_EVENTS', eventStore: Ht({def: n, instance: r})}), this.triggerEventAdd(e)),
              e
            );
          }
          var o,
  ...
  var Jn = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeYears = function (e, t) {
          ...
          return Pe(e) === Pe(t) && n.getMarkerDay(e) === n.getMarkerDay(t) && n.getMarkerMonth(e) === n.getMarkerMonth(t)
  ...
  function Dr() {
    return (
      null === Sr &&
        (Sr = (function () {
          var e = document.createElement('div');
          q(e, {position: 'absolute', top: -1e3, left: 0, border: 0, padding: 0, overflow: 'scroll', direction: 'rtl'}),
            (e.innerHTML = '<div></div>'),
            document.body.appendChild(e);
      ...
      a.fetch(
        ...
        function (r) {
          console.warn(r.message, r),
            ...
            n.dispatch({type: 'RECEIVE_EVENT_ERROR', sourceId: e.sourceId, fetchId: s, fetchRange: t, error: r});
        },
      ),
      ...
      (e.prototype._handleAction = function (e) {
        ...
        for (
          var p = Mo(n.eventSources, e, d, u),
            ...
            v = (f && !l.options.progressiveEventRendering && n.renderableEventStore) || h,
  ...
  function oi(e) {
    ...
    return {
      ...
      selectionConfig: Ft({constraint: t.selectConstraint, overlap: 'boolean' == typeof t.selectOverlap ? t.selectOverlap : void 0, allow: t.selectAllow}, e),
    };
  }
  function ii(e) {
        ...
        return (
          (n.handleSegClick = function (e, t) {
            ...
            if (i && r.isValidSegDownEl(e.target)) {
              ...
              o.emitter.trigger('eventClick', {el: t, event: new Bn(r.context, i.eventRange.def, i.eventRange.instance), jsEvent: e, view: o.viewApi}),
      ...
      return (
        ...
        (t.prototype.triggerEvent = function (e, t, n) {
          ...
          (t && !r.isValidSegDownEl(t.target)) ||
            o.emitter.trigger(e, {el: n, event: new Bn(o, i.eventRange.def, i.eventRange.instance), jsEvent: t, view: o.viewApi});
        }),
        t
      );
    })(ui),
      ...
      function t() {
        ...
        return (
          ...
          (t.registerInteractiveComponent = function (e, n) {
            var r = ci(e, n),
              o = [Si, Di].concat(t.props.pluginHooks.componentInteractions).map(function (e) {
                return new e(r);
              });
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            jr.Provider,
            {value: l},
            n.headerToolbar && Ar(yi, r({ref: this.headerRef, extraClassName: 'fc-header-toolbar', model: n.headerToolbar}, i)),
            Ar(Ei, {liquid: a, height: s, aspectRatio: e, onClick: this.handleNavLinkClick}, this.renderView(t), this.buildAppendContent()),
            n.footerToolbar && Ar(yi, r({ref: this.footerRef, extraClassName: 'fc-footer-toolbar', model: n.footerToolbar}, i)),
          );
        }),
        (t.prototype.componentDidMount = function () {
          var e = this.props;
            ...
            function (e, t, n, o) {
              return Ar(
                ...
                Ar(
                  ...
                  !u.isDisabled && Ar('a', r({ref: n, className: ['fc-col-header-cell-cushion', a.isSticky ? 'fc-sticky' : ''].join(' ')}, p), o),
                ),
              );
            },
          );
            ...
            function (t, n, o, i) {
              return Ar(
                ...
                Ar(
                  'div',
                  {className: 'fc-scrollgrid-sync-inner'},
                  Ar('a', {className: ['fc-col-header-cell-cushion', e.isSticky ? 'fc-sticky' : ''].join(' '), ref: o}, i),
                ),
              );
            },
          );
      ...
      (t.prototype.render = function () {
        ...
        return Ar(Ii, {unit: 'day'}, function (e, t) {
          return Ar(
            ...
            n.map(function (e) {
              return o
                ? Ar(xi, {key: e.toISOString(), date: e, dateProfile: r, todayRange: t, colCnt: n.length, dayHeaderFormat: a})
  ...
  function Yi(e, t) {
    for (var n = [], r = 0, i = e; r < i.length; r++)
      for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
        n.push(Ar('col', {style: {width: 'shrink' === a.width ? Zi(t) : a.width || '', minWidth: a.minWidth || ''}}));
    ...
    return (
      ...
      (t.prototype.renderSection = function (e, t, n) {
        return 'outerContent' in e
          ...
          : Ar('tr', {key: e.key, className: Ji(e, this.props.liquid).join(' ')}, this.renderChunkTd(e, t, n, e.chunk));
      }),
      ...
      return (
        ...
        (o.handleRenderRequest = function () {
          if (o.isRendering) {
            ...
            var e = o.currentData;
            Ur(
              Ar(Ri, {options: e.calendarOptions, theme: e.theme, emitter: e.emitter}, function (t, n, i, a) {
                return o.setClassNames(t), o.setHeight(n), Ar(ho.Provider, {value: o.customContentRenderId}, Ar(bi, r({isHeightAuto: i, forPrint: a}, e)));
              }),
              o.el,
            );
    ...
    Ea = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (ma += 1) && window.addEventListener('touchmove', Sa, {passive: !1});
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener('mousedown', this.handleMouseDown),
            this.containerEl.removeEventListener('touchstart', this.handleTouchStart, {passive: !0}),
            (ma -= 1) || window.removeEventListener('touchmove', Sa, {passive: !1});
        }),
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0 ? (this.everMovedUp = !0) : o > 0 && (this.everMovedDown = !0),
              ...
              this.isAnimating || ((this.isAnimating = !0), this.requestAnimation(Ra()));
          }
        }),
          ...
          if (s && s.isWithinClipping(e, t)) {
            ...
            if (c >= 0 && c < f && d >= 0 && d < h) {
              ...
              v &&
                ...
                (!o || v.layer > o.layer) &&
                ((v.rect.left += l), (v.rect.right += l), (v.rect.top += u), (v.rect.bottom += u), (o = v));
            }
          }
        }
        return o;
          ...
          (o.relevantEvents = Ot(l.getCurrentData().eventStore, c)),
            ...
            (i.delay =
              e.isTouch && c !== r.props.eventSelection
                ...
                : null),
            s.fixedMirrorParent ? (a.parentNode = s.fixedMirrorParent) : (a.parentNode = F(t, '.fc')),
        ...
        (o.handleDragStart = function (e) {
          ...
          e.isTouch ? r !== o.component.props.eventSelection && t.dispatch({type: 'SELECT_EVENT', eventInstanceId: r}) : t.dispatch({type: 'UNSELECT_EVENT'}),
            o.isDragging &&
              ...
              t.emitter.trigger('eventDragStart', {el: o.subjectEl, event: new Bn(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi}));
        }),
            ...
            if (e) {
              ...
              i === a || (p.editable && p.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  (c.mutatedEvents = l),
                  d.isInteractionValid(c) || ((u = !0), (s = null), (l = null), (c.mutatedEvents = {defs: {}, instances: {}})))
                : (a = null);
            }
            o.displayDrag(a, c),
              u ? te() : ne(),
            ...
            if ((o.clearDrag(), t.emitter.trigger('eventDragStop', {el: o.subjectEl, event: c, jsEvent: e.origEvent, view: n}), s)) {
              if (a === t) {
                ...
                a.emitter.trigger('eventAdd', w),
                  ...
                  a.emitter.trigger('drop', r(r({}, Ia(f.dateSpan, a)), {draggedEl: e.subjectEl, jsEvent: e.origEvent, view: f.component.context.viewApi})),
      ...
      (n.draggingSegEl = null),
        ...
        (n.handleDragStart = function (e) {
          ...
          (n.draggingSegEl = o),
            ...
            t.emitter.trigger('eventResizeStart', {el: o, event: new Bn(t, r.def, r.instance), jsEvent: e.origEvent, view: t.viewApi});
        }),
        (n.handleHitUpdate = function (e, t, o) {
          ...
          e &&
            ...
            u &&
              ...
              (p.mutatedEvents = c),
              n.component.isInteractionValid(p) || ((d = !0), (u = null), (c = null), (p.mutatedEvents = null))),
            c ? i.dispatch({type: 'SET_EVENT_RESIZE', state: p}) : i.dispatch({type: 'UNSET_EVENT_RESIZE'}),
            d ? te() : ne(),
            t || (u && _a(s, e) && (u = null), (n.validMutation = u), (n.mutatedRelevantEvents = c));
        }),
        (n.handleDragEnd = function (e) {
          var t = n.component.context,
            o = n.eventRange.def,
      ...
      return (
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r) {
          ...
          return (
            ...
            l && u.push({type: 'footer', key: 'footer', isSticky: !0, chunks: [{key: 'main', content: $i}]}),
            Ar(Do, {viewSpec: a.viewSpec}, function (e, t) {
              return Ar(
                'div',
                {ref: e, className: ['fc-daygrid'].concat(t).join(' ')},
                Ar(o, {liquid: !i.isHeightAuto && !i.forPrint, colGroups: [{cols: [{span: n, minWidth: r}]}], sections: u}),
              );
            })
          );
        }),
      ...
      (t.prototype.render = function () {
        ...
        return Ar(
          ...
          function (n, o) {
            return (
              (o || e.forceDayTop) &&
              Ar('div', {className: 'fc-daygrid-day-top', ref: n}, Ar('a', r({className: 'fc-daygrid-day-number'}, t), o || Ar(Wr, null, ' ')))
            );
          },
        );
      }),
            ...
            function (t, o, c, d) {
              return Ar(
                ...
                Ar(
                  ...
                  i.showWeekNumber &&
                    Ar(fa, {date: a, defaultFormat: Ka}, function (e, t, n, o) {
    ...
    for (var E = 0; E < s; E += 1) {
      for (var S = 0, D = 0, b = 0, C = u[E]; b < C.length; b++) {
        ...
        d[(w = R.seg).eventRange.instance.instanceId] ||
          ...
          w.firstCol === w.lastCol && w.isStart && w.isEnd ? ((f[w.eventRange.instance.instanceId] = R.top - S), (D = 0), (S = R.bottom)) : (D = R.bottom - S));
      }
      D && (c[E] ? (h[E] = D) : (v[E] = D));
    }
    function T(e, t) {
        ...
        if (p)
          for (var v = 0, g = e; v < g.length; v++) {
            var m = g[v],
              ...
              T = void 0;
            b
              ? ((w = n[y]), c.isRtl ? ((T = 0), (R = p.lefts[m.lastCol] - p.lefts[m.firstCol])) : ((R = 0), (T = p.rights[m.firstCol] - p.rights[m.lastCol])))
              : (C = o[y]),
              h.push(
                Ar(
                  'div',
                  ...
                  es(m)
                    ? Ar(ts, r({seg: m, isDragging: s, isSelected: y === d, defaultDisplayEventEnd: f}, bn(m, a)))
                    : Ar(rs, r({seg: m, isDragging: s, isResizing: l, isDateSelecting: u, isSelected: y === d, defaultDisplayEventEnd: f}, bn(m, a))),
                ),
              );
          }
        return h;
      ...
      function t() {
        ...
        return (
          (t.handlePopoverEl = function (e) {
            (t.popoverEl = e), e ? t.context.registerInteractiveComponent(t, {el: e, useEventCenter: !1}) : t.context.unregisterInteractiveComponent(t);
          }),
          t
        );
      }
            ...
            return Ar(
              ...
              o.segs.map(function (e) {
                ...
                return Ar(
                  ...
                  es(e)
                    ? Ar(ts, r({seg: e, isDragging: !1, isSelected: t === u, defaultDisplayEventEnd: !1}, bn(e, s)))
                    : Ar(rs, r({seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: t === u, defaultDisplayEventEnd: !1}, bn(e, s))),
                );
              }),
            );
          });
      ...
      function t() {
        ...
        return (
          ...
          (t.handleMoreLinkClick = function (e) {
            ...
            'function' == typeof i &&
              (i = i({date: o.toDate(e.date), allDay: !0, allSegs: e.allSegs.map(a), hiddenSegs: e.hiddenSegs.map(a), jsEvent: e.ev, view: n.viewApi})),
              i && 'popover' !== i
                ? 'string' == typeof i && n.calendarApi.zoomTo(e.date, i)
                : t.setState({morePopoverState: r(r({}, e), {currentFgEventSegs: t.props.fgEventSegs})});
          }),
        ...
        (t.prototype.queryHit = function (e, t) {
          ...
          return n
            ? {
                ...
                dateSpan: n.dateSpan,
                dayEl: n.dayEl,
                rect: {left: n.relativeRect.left, right: n.relativeRect.right, top: n.relativeRect.top, bottom: n.relativeRect.bottom},
                layer: 0,
              }
            : null;
        }),
            ...
            return (
              ...
              (t.prototype.buildRenderRange = function (t, n, r) {
                var o,
                  ...
                  s = a.start,
                  l = a.end;
                (/^(year|month)$/.test(n) && ((s = i.startOfWeek(s)), (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = ge(o, 1))),
        ...
        function (n, r, o, i) {
          return Ar(
            ...
            Ar(
              ...
              Ar('div', {className: 'fc-timegrid-slot-label-cushion fc-scrollgrid-shrink-cushion', ref: o}, i),
            ),
          );
        },
      );
        ...
        return (
          ...
          (t.renderHeadAxis = function (e) {
            ...
            return n.weekNumbers
              ? Ar(fa, {date: o.start, defaultFormat: Cs}, function (t, n, o, i) {
                  return Ar(
                    'th',
                    {ref: t, className: ['fc-timegrid-axis', 'fc-scrollgrid-shrink'].concat(n).join(' ')},
                    Ar(
                      'div',
                      {className: 'fc-timegrid-axis-frame fc-scrollgrid-shrink-frame fc-timegrid-axis-frame-liquid', style: {height: e}},
                      Ar('a', r({ref: o, className: 'fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner'}, a), i),
                    ),
                  );
                })
              : Ar('th', {className: 'fc-timegrid-axis'}, Ar('div', {className: 'fc-timegrid-axis-frame', style: {height: e}}));
          }),
            ...
            t &&
              ...
              i.push({
                ...
                outerContent: Ar(
                  ...
                  Ar('td', {className: 'fc-timegrid-divider ' + r.theme.getClass('tableCellShaded')}),
                ),
              })),
            ...
            t &&
              ...
              f.push({
                ...
                outerContent: Ar(
                  'tr',
                  {className: 'fc-scrollgrid-section'},
                  Ar('td', {colSpan: 2, className: 'fc-timegrid-divider ' + u.theme.getClass('tableCellShaded')}),
                ),
              }));
              ...
              chunks: [
                {
                  ...
                  content: function (e) {
                    return Ar(
                      ...
                      Ar('table', {style: {height: e.expandRows ? e.clientHeight : ''}}, e.tableColGroupNode, Ar('tbody', null, Ar(bs, {slatMetas: i}))),
                      Ar(
                        'div',
                        {className: 'fc-timegrid-now-indicator-container'},
                        Ar(Ii, {unit: h ? 'minute' : 'day'}, function (e) {
                          var t = h && a && a.safeComputeTop(e);
                          return 'number' == typeof t
                            ? Ar(ia, {isAxis: !0, date: e}, function (e, n, r, o) {
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            ...
            Ar(
              ...
              e.tableColGroupNode,
              Ar(ks, {slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas}),
            ),
          );
        }),
        (t.prototype.componentDidMount = function () {
      ...
      (function (e, t) {
        ...
        if (
          ((function (e) {
            var t, n, r, o, i;
            for (t = 0; t < e.length; t += 1)
              for (n = e[t], r = 0; r < n.length; r += 1) for ((o = n[r]).forwardSegs = [], i = t + 1; i < e.length; i += 1) Ns(o, e[i], o.forwardSegs);
          })(i),
          (o = i[0]))
        ) {
  ...
  var Us = bt({hour: 'numeric', minute: '2-digit', meridiem: !1}),
    Ls = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return this.props.isCondensed && e.push('fc-timegrid-event-condensed'), Ar(ra, r({}, this.props, {defaultTimeFormat: Us, extraClassNames: e}));
        }),
        t
      );
    })(Yr),
    Ws = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props;
          return Ar(sa, {date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, extraHookProps: e.extraHookProps}, function (e, t) {
      ...
      return (
            ...
            function (a, s, l) {
              return Ar(
                ...
                Ar(
                  ...
                  Ar(Ws, {date: t.date, dateProfile: t.dateProfile, todayRange: t.todayRange, extraHookProps: t.extraHookProps}),
                ),
              );
            },
          );
        ...
        (t.prototype.renderPrintFgSegs = function (e) {
          ...
          return (e = gn(e, this.context.options.eventOrder)).map(function (e) {
            return Ar(
              ...
              Ar(Ls, r({seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: !1, isCondensed: !1}, bn(e, t.todayRange, t.nowDate))),
            );
          });
        }),
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          ...
          var a = e.map(function (e) {
            return Ar(
              'div',
              {key: wn(e.eventRange), className: 'fc-timegrid-bg-harness', style: n.computeSegTopBottomCss(e)},
                    ...
                    Ar(
                      ...
                      Ar(
                        ...
                        Ar(
                          ...
                          {className: 'fc-timegrid-now-indicator-container'},
                          'number' == typeof n &&
                            Ar(ia, {isAxis: !0, date: t.nowDate}, function (e, t, r, o) {
  ...
  var Js = lo({
      ...
      views: {
        timeGrid: {component: Xs, usesMinMaxTime: !0, allDaySlot: !0, slotDuration: '00:30:00', slotEventOverlap: !0},
          ...
          return Ar(
            ...
            function (e, n, r, o) {
              return Ar(
                ...
                Ar('th', {colSpan: 3}, Ar('div', {className: 'fc-list-day-cushion ' + i.getClass('tableCellShaded'), ref: r}, o)),
              );
            },
          );
        }),
            ...
            function (e, o, i, a, s) {
              return Ar(
                ...
                Ar(
                  ...
                  Ar('span', {className: 'fc-list-event-dot', style: {borderColor: s.borderColor || s.backgroundColor}}),
                ),
  ...
  var ll = lo({
      optionRefiners: {listDayFormat: sl, listDaySideFormat: sl, noEventsClassNames: Pt, noEventsContent: Pt, noEventsDidMount: Pt, noEventsWillUnmount: Pt},
      views: {
        list: {component: ol, buttonTextKey: 'list', listDayFormat: {month: 'long', day: 'numeric', year: 'numeric'}},
  ...
  (ul.prototype.classes = {
    ...
    (ul.prototype.rtlIconClasses = {prev: 'fa-chevron-right', next: 'fa-chevron-left', prevYear: 'fa-angle-double-right', nextYear: 'fa-angle-double-left'}),
