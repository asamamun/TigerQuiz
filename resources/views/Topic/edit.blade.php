...
@section('content')
    <div class="card card-hover shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <a href="{{url('topic')}}" class="btn btn-primary btn-circle btn-sm" title="Back to Subject">
...
<div class="form-group row">
<div class="col-sm-6 mb-3 mb-sm-0">
    {!! Form::select('subcategory_id', $subcategories, null, ['placeholder' => 'Select Subject', 'class'=>'form-control form-control-profile']) !!}
</div>
<div class="col-sm-6">
