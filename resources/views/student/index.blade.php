                ...
                <div class="col-xl-6">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h4 class="text-info"><i class="fas fa-chart-area me-1"></i>Latest Quiz Compitions and Results
                            </h4>
                        </div>
                        ...
                        @foreach ($marks as $mark)
                            <tbody>
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ url('/quiz/qz/qshow') }}">{{ $mark->quizset->name ?? 'Random Quizzes' }}</a>
                                    </td>
                                    <td>{{ $mark->marks }}</td>
                                    <td>{{ $mark->tquiz }}</td>
                                    {{-- <td>{{ $mark->type}}</td> --}}
                                    <td>{{ $mark->Quizset->user->name ?? 'User' }}</td>
