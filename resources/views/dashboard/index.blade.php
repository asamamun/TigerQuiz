...
<div class="page-flex">
    ...
    <div class="sidebar-start">
        <div class="sidebar-head">
            <a href="/" class="logo-wrapper" title="Home">
                ...
                <div class="logo-text">
                    <span class="logo-title text-warning">Tiger</span>
                    <span class="logo-title text-light">Quiz</span>
                </div>
            ...
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon document" aria-hidden="true"></span>Quizzes
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="posts.html">All quizzes</a>
                        </li>
                        <li>
                            <a href="new-post.html">Add quizzes</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="categories.html">All classes</a>
                        </li>
                        <li>
                            <a href="categories.html">Add classes</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon image" aria-hidden="true"></span>Subcategories
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="media-01.html">All subjects</a>
                        </li>
                        <li>
                            <a href="media-02.html">Add subjects</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon paper" aria-hidden="true"></span>Topics
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="pages.html">All chapters</a>
                        </li>
                        <li>
                            <a href="new-page.html">Add chapters</a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <div class="main-nav-end">
      ...
      <div class="nav-user-wrapper">
        ...
        <ul class="users-item-dropdown nav-user-dropdown dropdown">
          <li><a href="##">
              <i data-feather="user" aria-hidden="true"></i>{{ Auth::user()->name }}
            </a></li>
          <li><a href="##">
          ...
          <li><a class="danger" href="##">
              <span class="align-middle">
                <form method="POST" action="{{ route('logout') }}">
                  ...
                  <i data-feather="log-out" aria-hidden="true"></i>{{ __('Log Out') }}</a>
              </form>
              </span>
            </a></li>
        </ul>
        ...
        <div class="row stat-cards">
          ...
          <div class="col-md-6 col-xl-3">
            <article class="stat-cards-item">
              ...
              <div class="stat-cards-info">
                <p class="stat-cards-info__num">1478 286</p>
                <p class="stat-cards-info__title">Total Quiz Sets</p>
                <p class="stat-cards-info__progress">
  ...
  <div class="container footer--flex">
    <div class="footer-start">
      <p>{{date("Y")}} © Tiger Quiz - <a href="elegant-dashboard.com" target="_blank"
          rel="noopener noreferrer">www.tigerquiz.com</a></p>
    </div>
    <ul class="footer-end">
